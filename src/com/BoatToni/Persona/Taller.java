...
public class Taller extends Empleat {
    ...
    public String toString() {
        return "Taller{"+ "nom= " + nom + "llinatges= " + llinatges + "tipusDocument= " + document + "numDocument= " + numDocument + "adreça= " + adreça + "email= " + email + "telefon= " + telefon + "dataAlta= " + dataAlta + "souTaller= " + souTaller + '}';
    }
